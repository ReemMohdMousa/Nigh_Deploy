...
export default function BasicMenu() {
  ...
  const getAllFriends = () => {
    axios
      .get(`https://nigh-deploy.onrender.com/friends/get/all/${userId}`, {
  ...
  const cancelFriendReqFun = (receiver_id) => {
    axios
      .delete(
        `https://nigh-deploy.onrender.com/friends/cancel/${receiver_id}`,
        {
          headers: { Authorization: `Bearer ${token}` },
        }
      )
  ...
  const declineFriendReqFun = (sender_id) => {
    axios
      .delete(`https://nigh-deploy.onrender.com/friends/decline/${sender_id}`, {
        headers: { Authorization: `Bearer ${token}` },
      })
      .then(function (response) {
        // console.log(response.data.result);
